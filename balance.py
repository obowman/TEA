...
# BALANCE.PY
# In-shell inputs: header file, name of data directory, True/False Printing
#
# FOR TESTING
'''
python balance.py full_White2.txt testing2 True
'''
